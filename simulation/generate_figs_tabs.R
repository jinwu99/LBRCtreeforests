...
##### figure 3 & S1: validation of OOB tuning for LBRCforests #####
...
##### figure 4 & S2 & S3: prediction comparison across models #####
...
##### table S1: test of unbiasedness of variable selection of LBRCtrees #####
Unbiasedness_table <- function(results_dir){
...
generate_figures_tables <- function(mode, results_dir){
  ...
  }else if(mode == "table_S1_test_unbiasedness_LBRCtrees"){
    Unbiasedness_table(results_dir)
  }
}
